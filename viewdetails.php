                ...
                <h5 style="color: green; font-size:18px; ">
                   ...
                   $sql=mysqli_query($con,"select * from `tblpatients`  where Id='".$_SESSION['id']."'");
                    ...
                    <div class="form-group">
	                      ...
	                      <input type="text" name="username" class="form-control" value="<?php echo htmlentities($data['firstName']);?>" >
												</div>
												<div class="form-group">
                          ...
                          <div class="form-group">
		                           ...
		                           <input type="number" name="contactNo" class="form-control"  readonly="readonly" required="required"  value="<?php echo htmlentities($data['emergencyContact']);?>" >
													</div>
													<div class="form-group">
															<label for="emergencyPerson">Emergency Person</label>
		                           <input type="text" name="emergencyPerson" class="form-control"  required="required"  value="<?php echo htmlentities($data['emergencyPerson']);?>" >
													</div>
													<div class="form-group">
															<label for="emergencyContact">Emergency Contact</label>
		                           <input type="number" name="emergencyContact" class="form-control"  readonly="readonly" required="required"  value="<?php echo htmlentities($data['emergencyContact']);?>" >
													</div>

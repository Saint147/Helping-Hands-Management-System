...
<head>
    ...
    <title> HELPING HANDS MANAGEMENT SYSTEM </title>
            ...
            <ol class="carousel-indicators">
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">Helping Hands Managements System</h5>
                    </div>
        ...
        <div class="inner-title">
            ...
            <div class="col-sm-12 blog-cont">
                <div class="row no-margin">
                    ...
                    <div class="inner-title">
                        <a class="btn btn-success" href="login.php">Submit Care Contract</a>
</div>
                </div>
            </div>
    ...
    <section id="services" class="key-features department">
        <div class="container">
            <div class="inner-title">
                ...
                <h2>Services and Departments</h2>
                <p>Take a look at some of our key services,patners and departments</p>
            </div>
...
?>
    ...
    <p><?php  echo $row['description'];?>.</p><?php } ?>
        ...
        <div class="gallery-filter d-none d-sm-block">
            ...
            <button class="btn btn-default filter-button" data-filter="irrigation">Facilities</button>
        </div>
        <br/>

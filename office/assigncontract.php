						...
						<div class="container-fluid container-fullw bg-white">
							<div class="row">
								...
								<?php echo htmlentities($_SESSION['msg']="");?></p>	
													<form role="form" action="assigncontract.php" method="post" >
                                                    <div class="form-group">
															<label for="exampleInputEmail1">
																Contract For<span style="color:red" align="inline"> *
															</label>
															<a href="assigncontract.php?id=<?php echo $row['contractId'];?>" class="btn btn-transparent btn-xs" tooltip-placement="top" data-toggle="tooltip" title="The below selection list consist of patients with new contract,select patients and assign nurse to the contract!"><i class="fa fa-info"></i></a>
															<div class="form-group">
...
<?php $sql=mysqli_query($con,"select * from `tblpatients` join `tblcarecontract` on tblpatients.patientId = tblcarecontract.patientId
    WHERE tblcarecontract.statuss='New'");
...
?>
	<option value="<?php echo htmlentities($row['patientId']);?>">
														...
														<div class="form-group">
															<label for="exampleInputEmail1">
																Assign Nurse To Contract<span style="color:red" align="inline"> *  <a href="assigncontract.php?id=<?php echo $row['contractId'];?>" class="btn btn-transparent btn-xs" tooltip-placement="top" data-toggle="tooltip" title="The below drop down list consist of nurse, please select a nurse to assign it with the selected patient contract!"><i class="fa fa-info"></i></a>
															</label>
															<div class="form-group">

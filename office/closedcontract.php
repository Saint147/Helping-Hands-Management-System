...
<html lang="en">
	<head>
		<title>Office Admin | Closed | Contracts</title>
...
<div class="row">
<div class="col-md-12">
<h5 class="over-title margin-bottom-15"> <span class="text-bold">Closed Contracts List</span></h5>
...
$sql="select * from `tblcarecontract` join  `tblnurse` on tblcarecontract.nurseId=tblnurse.nurseId  join `tblsuburbs` on tblcarecontract.suburbId=tblsuburbs.suburbId join `tblpatients` on tblcarecontract.patientId=tblpatients.patientId where statuss='Closed' ";

				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">View Nurse| Suburb</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Prefferd Suburb</span>
									</li>
									<li class="active">
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Suburb Per nurse</h5>
												</div>
												<div class="panel-body">
									
													<form role="form" method="post" action="nursereport.php">
                                                    <div class="form-group">
										<label for="condition">
																Nurse <span style="color:red" align="inline"> *</span>
															</label>

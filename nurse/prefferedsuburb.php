...
$sql=mysqli_query($con,"insert into `tblprefferedsuburb` (suburbId,nurseId) values('$sub','$nurse')");
if($sql)
{
$msg="Prefferd Suburb Inserted Successfully";
}else{
...
<html lang="en">
	<head>
		<title>Nurse | Preffered Suburb</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Nurse | Add Suburb </h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Nurse</span>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Add Preffered Suburb to Your Profile</h5>
												</div>
												<p align="center" style="color:red" > Mandatory fields marked with asteriks (*) </p>
												<div class="panel-body">  <hr />
									<form role="form" action="prefferedsuburb.php" method="post">
...
<?php $ret=mysqli_query($con,"select * from `tblnurse`  join `tbluuser` on tblnurse.Id=tbluuser.Id where tblnurse.Id='".$_SESSION['id']."'");
while($row=mysqli_fetch_array($ret))
{
?>
	<option selected value="<?php echo htmlentities($row['nurseId']);?>">
...
?>
	<option value="<?php echo htmlentities($row['suburbId']);?>">
                                    ...
                                    <button type="submit" name="submit" class="btn btn-o btn-primary">Add Suburb</button>
								</form>

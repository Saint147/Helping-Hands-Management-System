...
$sql=mysqli_query($con,"update  `tblcarecontract` set  endCareDate='$end' where contractId='$id'");
if($sql){
...
{														
	...
	<?php } ?>
														...
														<div class="form-group">
															<label for="exampleInputEmail1">
																Assigned Nurse To Contract
															</label>
 
	<?php 
    //$id=intval($_GET['id']);
	$sql=mysqli_query($con,"select * from `tblnurse` join `tblcarecontract` on tblcarecontract.nurseId=tblnurse.nurseId where contractId='$id'");
while($row=mysqli_fetch_array($sql))
{														
	?><input type="text" name="nurseId" readonly class="form-control"  value="<?php echo $row['firstname'];?>" >
	<?php } ?></div>
	...
	<?php 
	$sql=mysqli_query($con,"select endCareDate from `tblcarecontract` where contractId='$id'");
while($row=mysqli_fetch_array($sql))
{														
	?>		
	<input type="date" name="endCareDate" class="form-control"  value="<?php  echo $row['endCareDate'];  ?> ">
	<?php } ?>
														</div>

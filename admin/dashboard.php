								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle">Manage Office Admin</h2>
											
											<p class="links cl-effect-1">
												<a href="manage-users.php">
												<?php $result = mysqli_query($con,"SELECT * FROM tbluuser ");
									...
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<p class="cl-effect-1">
												...
												<?php $result1 = mysqli_query($con,"SELECT * FROM tblnurse ");
									...
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<p class="links cl-effect-1">
												...
												<?php $sql= mysqli_query($con,"SELECT * FROM tblcarecontract");
